...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A luxury video editing studio helping creators, agencies, and brands turn raw footage into content that sells." },
      { property: "og:title", content: "Lumen Studio — Premium Video Editing" },
      { property: "og:description", content: "High-performance video editing for creators, agencies, and brands." },
